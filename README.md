...
The setup script activates the local Julia environment, installs MORFE, MORFEFerrite, and IJulia, and registers a Jupyter kernel called MORFEExamples. The kernel is configured to use the Julia environment of this repository.
